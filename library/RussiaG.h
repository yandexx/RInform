...
Verb	'вз' 'возьм'
	...
	'дост' 'доста' 'достав'
                ...
                * 'из'/'с'/'со' noun multiinside	-> Remove reverse
...
! "надеть"/"одеть"
Verb	'над' 'од' 'наде' 'оде'
                * cAcc_held				-> Wear;

! "раздеть"/"снять"
Verb	'разд' 'сн' 'разде' 'сним'
		* cAcc_worn				-> Disrobe;

Object "надеть" VerbDepot
	with name 'над' 'од' 'наде' 'оде';

Object "раздеть" VerbDepot
	with name 'разд' 'сн' 'разде' 'сним';
